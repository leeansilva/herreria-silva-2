...
import React, { useLayoutEffect, useCallback, useEffect, useState, useMemo, useRef } from "react";
  ...
  import { useMediaQuery, useTheme, Progress, VStack, Button, Flex, Box, Image } from "@chakra-ui/react";
  ...
  const ChakraCarousel = ({ children, gap, imagen }) => {
    ...
    return (
      ...
      {isModalOpen && (
        <Box
          ...
          onClick={closeModal}
        >
          <Image src={modalImage} maxH="90vh" maxW="90vw" borderRadius="5px" />
        </Box>
      )}
      </>
    );
